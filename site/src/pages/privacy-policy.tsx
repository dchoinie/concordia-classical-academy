    ...
    <>
      ...
      <Layout>
        <div className="max-w-screen-xl mx-6 lg:mx-auto my-24">
          ...
          <p className="mb-2">Last updated: January 21, 2023</p>
          <p className="mb-2">
          ...
          <h1 className="mb-3">Interpretation and Definitions</h1>
          ...
          <ul className="mb-2 list-disc">
            ...
            <li className="ml-6">
              <p className="mb-2">
                ...
                in this Agreement) refers to Concordia Classical Academy, 2101
                Lor Ray Drive, North Mankato, MN 56003.
              </p>
            </li>
            <li className="ml-6">
              <p className="mb-2">
            ...
            <li className="ml-6">
              <p className="mb-2">
                <strong>Website</strong> refers to Concordia Classical Academy,
                accessible from{" "}
                <a
          ...
          <h1 className="mb-3">Collecting and Using Your Personal Data</h1>
          ...
          <ul className="mb-2 list-disc">
            <li className="ml-6">Comply with a legal obligation</li>
            <li className="ml-6">Protect and defend the rights or property of the Company</li>
            <li className="ml-6">
            ...
            <li className="ml-6">Protect against legal liability</li>
          </ul>
          ...
          <ul className="mb-2 list-disc">
            <li className="ml-6">By email: ccamankato@gmail.com</li>
          </ul>
        </div>
      </Layout>
    </>
