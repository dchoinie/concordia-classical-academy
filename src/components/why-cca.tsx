...
const WhyCCAComponent = () => {
  return (
    <div className="my-12">
      ...
      <div className="my-36">
        <div className="flex flex-col max-w-2xl mx-auto text-center mb-24">
          ...
          <h6 className="text-gray-600">
            ...
            Christian world-vew. This is accomplished by a traditional classical
            curriculum which educates the whole child: academically, physically,
