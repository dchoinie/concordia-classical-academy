      ...
      <Layout>
        <div className="max-w-screen-xl mx-6 lg:mx-auto">
          ...
          <div className="my-24">
            ...
            <p className="mb-2">Welcome to Concordia Classical Academy!</p>

            <p className="mb-2">
              These terms and conditions outline the rules and regulations for
              the use of Concordia Classical Academy's Website, located at
              https://www.ccamankato.org.
            </p>

            <p className="mb-2">
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Concordia Classical Academy if
            ...
            <p className="mb-2">
              We employ the use of cookies. By accessing Concordia Classical
              Academy, you agreed to use cookies in agreement with the Concordia
              Classical Academy's Privacy Policy.{" "}
            </p>
            ...
            <p className="mb-2">
              Unless otherwise stated, Concordia Classical Academy and/or its
              licensors own the intellectual property rights for all material on
              Concordia Classical Academy. All intellectual property rights are
              reserved. You may access this from Concordia Classical Academy for
            ...
            <ul className="mb-2 list-disc">
              <li className="ml-6">Republish material from Concordia Classical Academy</li>
              <li className="ml-6">
                Sell, rent or sub-license material from Concordia Classical
                Academy
              </li>
              <li className="ml-6">
                Reproduce, duplicate or copy material from Concordia Classical
                Academy
              </li>
              <li className="ml-6">Redistribute content from Concordia Classical Academy</li>
            </ul>
            ...
            <p className="mb-2">
              ...
              Concordia Classical Academy does not filter, edit, publish or
              review Comments prior to their presence on the website. Comments
              do not reflect the views and opinions of Concordia Classical
              Academy,its agents and/or affiliates. Comments reflect the views
              and opinions of the person who post their views and opinions. To
              the extent permitted by applicable laws, Concordia Classical
              Academy shall not be liable for the Comments or for any liability,
            ...
            <p className="mb-2">
              Concordia Classical Academy reserves the right to monitor all
            ...
            <p className="mb-2">
              You hereby grant Concordia Classical Academy a non-exclusive
            ...
            <ul className="mb-2 list-disc">
              <li className="ml-6">Government agencies;</li>
              <li className="ml-6">Search engines;</li>
              <li className="ml-6">News organizations;</li>
              <li className="ml-6">
            ...
            <ul className="mb-2 list-disc">
              ...
              <li className="ml-6">dot.com community sites;</li>
              <li className="ml-6">associations or other groups representing charities;</li>
              <li className="ml-6">online directory distributors;</li>
              <li className="ml-6">internet portals;</li>
              <li className="ml-6">accounting, law and consulting firms; and</li>
              <li className="ml-6">educational institutions and trade associations.</li>
            </ul>
            ...
            <p className="mb-2">
              ...
              Concordia Classical Academy; and (d) the link is in the context of
            ...
            <p className="mb-2">
              ...
              by sending an e-mail to Concordia Classical Academy. Please
            ...
            <ul className="mb-2 list-disc">
              <li className="ml-6">By use of our corporate name; or</li>
              <li className="ml-6">
            ...
            <p className="mb-2">
              No use of Concordia Classical Academy's logo or other artwork will
